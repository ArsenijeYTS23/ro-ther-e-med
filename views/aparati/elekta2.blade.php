...
@section('sadrzaj')
<section id="team">
    <h1 style="text-align: center;">Elekta 2</h1>
    <div class="row">
        ...
        <table class="table table-hover">
            <tbody>
                ...
                <tr>
                    ...
                    @else
                    <td><a href="{{ url('ubaciElekta2/'.$id.'/'.$ele->id) }}"><span class="glyphicon glyphicon-plus"></span><span class="glyphicon glyphicon-user"></span></a></td>
                    @endif
                    @else
                    <td></td>
                    @endif
